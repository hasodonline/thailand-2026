...
PINS = [
    ...
    ("miipaaai",    "#a63b22", "🏘️ MiiPaaAii — בכפר ההררי",   "לילות 24–26 · ⭐5.0 · 8 דק׳ הליכה לדוכנים"),
    ("maekampong",  "#6b3fa0", "🏘️ כפר מאה קמפונג",          "חמישי · כפר הרים ב-1,300 מ׳ · ⭐4.5 (6,032)"),
    ("mkwaterfall", "#6b3fa0", "💦 מפל מאה קמפונג",           "דקה מהבקתה — הולכים ברגל"),
...
ROUTES = [
    ...
    (("chailai", "city", "hotsprings", "miipaaai"),  "חמישי · אל עמק ההרים",     "#6b3fa0", 5),
    (("miipaaai", "skyline"),                        "שישי · Skyline",           "#136b7a", 5),
    (("miipaaai", "airport"),                        "שבת · לשדה התעופה",        "#999999", 4),
]
