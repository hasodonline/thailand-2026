...
PINS = [
    ...
    ("tharnthong",  "#a63b22", "🏔️ הבקתות בעמק מאה און",      "לילות 24–26 · דקה מהמפל"),
...
ROUTES = [
    ...
    (("chailai", "city", "hotsprings", "tharnthong"),  "חמישי · אל עמק ההרים",     "#6b3fa0", 5),
    (("tharnthong", "skyline"),                        "שישי · Skyline",           "#136b7a", 5),
    (("tharnthong", "airport"),                        "שבת · לשדה התעופה",        "#999999", 4),
]
