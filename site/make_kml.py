...
PINS = [
    ...
    ("woomacamoo", "24–26.9", "🏘️ Woo Ma Ca Moo",
     "שני לילות בבקתות עץ מעל הנחל, ~1,300 מ'. שלושה חדרים ל-7.\n"
     "8 דקות הליכה למסעדת ערב, 20 דקות לדוכנים, 57 דקות מ-Skyline.\n"
     "✅ שולם ฿37,000 · ארוחות בוקר כלולות · ⭐4.8 · 165 ביקורות"),
    ("mkwaterfall", "חמישי–שישי", "💦 מפל מאה קמפונג",
     "שביל שמטפס לאורך המפל בין העצים, עם תצפית על העמק. "
     "50 דקות הליכה מהבקתות, 8 דקות ברכב.\n⭐4.5 · 2,925 ביקורות"),
    ...
    ("airport", "שבת 26.9", "✈️ שדה התעופה צ׳יאנג מאי",
     "PG242 ממריאה 11:35 לקוסמוי. יוצאים מהבקתות 08:00 — 72 דקות."),
]
...
ROUTES = [
    ...
    (("chailai", "city", "hotsprings", "woomacamoo"), "thu-hotsprings-mountains", "חמישי · אל עמק ההרים", "dda03f6b", 5),
    (("woomacamoo", "skyline"), "fri-skyline", "שישי · Skyline", "dd7a6b13", 5),
    (("woomacamoo", "airport"), "sat-airport", "שבת · לשדה התעופה", "99999999", 3),
]
